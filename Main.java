...
companyName, String qualification, double salary, String subject, String department, int teacherId) {
...
teachers[i] = new Teacher(name, gender, address, age, empId, companyName, qualification,
